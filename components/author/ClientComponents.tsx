...
import AnalyticsLineChart from "../../app/api/comments/analytics/LIneChart";
import MetricCard from "../../app/api/comments/analytics/MetricCard";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href="/author/blogs">View All</Link>
            </Button>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href="/author/blogs?sort=popular">View All</Link>
            </Button>
          </CardHeader>
          <CardContent>
            {topBlogs.length > 0 ? (
